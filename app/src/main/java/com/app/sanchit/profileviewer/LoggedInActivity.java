...
public class LoggedInActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView NavUserImage = (ImageView)headerView.findViewById(R.id.navHeaderUserImage);
        Users user = (Users)((getIntent()).getSerializableExtra("UserDetails"));
        NavUserName.setText(user.name);
        NavUserEmail.setText(user.email);
        Bitmap image = Users.toBitmap(user.imageByte);
        if(image!=null)
            NavUserImage.setImageBitmap(image);
    }
